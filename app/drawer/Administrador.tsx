  ...
  return (
    <View>
      <View style={[{backgroundColor:Colors.azulOscuro}, {width:400}, {height:200}, {alignSelf:'center'}, {flexDirection:'column'}, {borderRadius:20}, {top:'10%'}]}>
            ...
            <TextInput style={[{color:Colors.negro},{height:34},{fontWeight:'bold'}, {margin:5},{alignSelf:'center'}, {backgroundColor:Colors.fondo}, {borderRadius:10}, {width:200}, {fontSize:12}]} placeholder='Nombre'></TextInput>
